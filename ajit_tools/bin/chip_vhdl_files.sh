...
cp $AJIT_PROJECT_HOME/processor/Aa_v3/sys/chip/core/cpu/teu/cpunit/vhdl/teu_cpunit/cpunit.vhdl ./
...
cp $AJIT_PROJECT_HOME/processor/Aa_v3/sys/chip/core/cpu/teu/iunit/iu_writeback/vhdl/iunit_writeback/iu_writeback.vhdl ./
