...
def setGlobals(work_dir):
   ...
   # path of validation_parallel2.py
   path_validation_inner = ajit_project_home + "/tools/scripts/validation_inner_env_v2.py"
...
def help_sec ():
	...
	print " -----------------------------------------------------------------------------------------------------------"
	print " USAGE:"
	print "        validation_outer_env_v2.py [MODEL] [OPTIONS] [-t TIMEOUT_IN_SECONDS] [-j JOBS_TO_RUN_IN_PARALLEL]  PATHS..."
	print " -----------------------------------------------------------------------------------------------------------"
	print " MODEL:"
	...
	print " ------------------------"
	print " CLEANUP:"
	print "      validation_outer_env_v2.py -c PATHS..."
...
def main ():
	...
	if jobs == "" :
		...
		print "Use as - validation_outer_env_v2.py -choice -t <timeout> -j <parallel_jobs> <path1> <path2> ...\n"
		return 1
