compileToSparc.py -o 1 -I /usr/include -s init.s -c utils.c -c dhry_1.c -c dhry_2.c -E dhry.elf -V dhry.vars -H dhry.hex -M dhry.mmap -O dhry.objdump -D AJIT -D DHRYOPT -L LinkerScript.lnk
