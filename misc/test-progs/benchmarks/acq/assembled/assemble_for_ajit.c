...
compileToSparc.py -I /usr/include -I ./ -o 2 -s init.s -s setup_page_tables.s  -s $AJIT_TOOLS_RELEASE/ajit_access_routines/asm/trap_handlers.s -I $AJIT_TOOLS_RELEASE/ajit_access_routines/include -C $AJIT_TOOLS_RELEASE/ajit_access_routines/src -C $AJIT_TOOLS_RELEASE/minimal_printf_timer/src -I $AJIT_TOOLS_RELEASE/minimal_printf_timer/include -s opt-asmfiles/main-optbb.s -s opt-asmfiles/mem-optbb.s -s opt-asmfiles/scale-optbb.s -s opt-asmfiles/circshift-optbb.s -s opt-asmfiles/correlate-optbb.s -E mem_bw.elf -V mem_bw.vars -H mem_bw.hex -M mem_bw.mmap -O mem_bw.objdump  -L LinkerScript.lnk -D NITERS=4 -D NSIZE=8
