...
.L8:
	...
	.proc	015
crcu8:
	/*start bb 15, raw*/sethi	%hi(16384), %o5
	or	%o5, 2, %g1
	xor	%o0, %o1, %g3
	xor	%o1, %g1, %g4
	srl	%o0, 1, %g2
...
.L55:
	...
	/*end bb 43*/bne	.L79
	 or	%g1, %o1, %g1
.L57:
	/*start bb 44, raw*/and	%g4, 0xff, %o4
	sll	%g3, 16, %g2
	srl	%o4, 1, %g4
	srl	%g2, 16, %g1
	sethi	%hi(16384), %o5
...
.L136:
	...
	/*end bb 94*/bne	.L176
	 or	%g1, %o1, %g1
.L138:
	/*start bb 95, raw*/and	%g4, 0xff, %o4
	sll	%g3, 16, %g2
	srl	%o4, 1, %g4
	srl	%g2, 16, %g1
	sethi	%hi(16384), %o5
...
.L203:
	...
	/*end bb 122*/bne	.L226
	 or	%g1, %o1, %g1
.L205:
	/*start bb 123, raw*/and	%g3, 0xff, %o4
	sll	%o0, 16, %g2
	srl	%o4, 1, %g3
	srl	%g2, 16, %g1
	sethi	%hi(16384), %o5
...
.L207:
	...
	/*end bb 124*/bne	.L228
	 or	%g1, %o1, %g1
.L209:
	/*start bb 125, raw*/and	%g3, 0xff, %o4
	sll	%g4, 16, %g2
	srl	%o4, 1, %g3
	srl	%g2, 16, %g1
	sethi	%hi(16384), %o1
