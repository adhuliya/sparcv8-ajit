...
_start:
	...
	mov -3, %g2		!move -3 into g2
	mov 2, %g3		!move 2 into g3
	add %g2,%g3,%g4 ! add contents of g2 and g3 into g4 
					! g4 should contain -1 = 0xffffffff
	mov 3, %g5      	! move 3 into g5
	add %g3, %g5, %o2 	! o2 should contain 5
	addcc %r0, %r0, %g5 	! r5 = 0, Z-flag set.
	rd %psr, %o0	    	! save psr with Z flag into o0
	subcc %r0, %g2, %g6   	! r6 = +3, N-flag set.
	rd %psr, %o1	    	! save psr with N flag into o1
        sub %g3, %g6, %g7   	! r7 = -1
	ta 0			! end of test
